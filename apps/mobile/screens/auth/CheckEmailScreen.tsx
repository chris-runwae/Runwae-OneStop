...
const CheckEmailScreen = () => {
  ...
  const handleOpenEmail = () => {
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
    // Note: In real app, we would use Linking to open mail app, 
    // but here we just simulate or navigate to reset-password for testing
      ...
      <View className="flex flex-1 justify-between">
        ...
        <View style={{ paddingBottom: 24 }}>
          ...
          <TouchableOpacity
            ...
            className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 h-[45px] rounded-full w-full flex items-center justify-center"
          >
            <Text className="text-gray-700 dark:text-gray-300 font-medium text-base">Close</Text>
          </TouchableOpacity>
        </View>
      </View>
    </AppSafeAreaView>
