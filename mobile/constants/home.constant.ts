    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          'The most beautiful way to see Miami. The cocktails were top notch!',
      ...
      },
      {
        ...
        rating: 4,
        comment:
          'Beautiful boat and great service. The music was a bit loud but the view was worth it.',
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'Perfect for date night. The city lights from the water are incredible.',
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'Lovely experience. The staff was very attentive and the drinks were delicious.',
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Great value for money. A must-do if you're in Miami for the weekend.",
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          'Great music, even better wine. Highly recommend for a relaxed night.',
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'An incredible evening. The sommelier really knew their stuff.',
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'The atmosphere was electric! Best jazz club experience in the city.',
      ...
      },
      {
        ...
        rating: 4,
        comment:
          'Wonderful wine selection. I wish the set was a bit longer, but overall great.',
  ...
  },
  {
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'The pilot was great and the views of the coast were unmatched.',
      ...
      },
      {
        ...
        rating: 4,
        comment:
          'Great tour! It was a bit short, but we saw a lot in 30 minutes.',
...
export const DESTINATIONS_FOR_YOU: Destination[] = [
  {
    ...
    image:
      'https://images.unsplash.com/photo-1589104602532-9cee07f8f62c?q=80&w=1928&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    rating: 4.8,
    reviewCount: 320,
    description:
  ...
  },
  {
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'Amazing food and wonderful service. A truly unforgettable night.',
  ...
  },
  {
    ...
    whatToKnow: [
      ...
      },
      {
        ...
        description:
          'Moderate activity; involves swimming and equipment handling.',
      },
      {
        icon: 'life-buoy',
        title: 'Safety First',
        description:
          'Fully certified instructors guide every step of the dive.',
      },
      {
        icon: 'camera',
    ...
    reviews: [
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'Key Largo has some of the best diving spots. This tour was top-notch.',
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'Incredible marine life. Saw turtles, rays, and so many colorful fish.',
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'A fantastic underwater adventure. Highly recommended for divers.',
