...
export function ShowOnEventPageToggle({
  checked,
  onChange,
}: ShowOnEventPageToggleProps) {
  return (
    <div className="flex">
      <div>
        <p className="font-semibold text-body font-bricolage">
          Show on the Event Page
        </p>
        <p className="text-sm text-muted-foreground">
          Help them set up their profile so they show up nicely on the event
          page.
        </p>
      </div>
      <button
