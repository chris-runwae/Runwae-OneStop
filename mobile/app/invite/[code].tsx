...
export default function InviteScreen() {
  ...
  if (loading) {
    return (
      <View style={[styles.center, { backgroundColor: colors.backgroundColors.default }]}>
  ...
  if (!trip) {
    return (
      <View style={[styles.center, { backgroundColor: colors.backgroundColors.default, paddingTop: insets.top }]}>
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.backgroundColors.default, paddingTop: insets.top + 24 }]}>
...
const styles = StyleSheet.create({
  ...
  iconWrap: { width: 72, height: 72, borderRadius: 36, backgroundColor: '#FF1F8C15', alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  ...
  btn: { backgroundColor: '#FF1F8C', borderRadius: 12, paddingVertical: 15, paddingHorizontal: 40, marginTop: 20, minWidth: 200, alignItems: 'center' },
